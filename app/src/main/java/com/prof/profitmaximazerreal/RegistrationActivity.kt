package com.prof.profitmaximazerreal
...
import com.prof.profitmaximazerreal.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.regButton.setOnClickListener {
            ...
            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5dbe0e18abff98696ed5bc93",ed2stName,ed_tel,"yhterfhrxsx")
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            response.body()?.data?.pr.equals("success") -> {
                                ...
                                startActivity(i)
                                binding.regButton.setBackgroundResource(R.drawable.bg_click_selector)
